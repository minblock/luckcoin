...
"""Verify that starting luckcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start luckcoin with -h for help text")
        ...
        self.log.info("Start luckcoin with -version for version information")
        ...
        self.log.info("Start luckcoind with -fakearg to make sure it does not start")
