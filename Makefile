...
pkgdatadir = $(datadir)/luckcoin
pkgincludedir = $(includedir)/luckcoin
pkglibdir = $(libdir)/luckcoin
pkglibexecdir = $(libexecdir)/luckcoin
...
ACLOCAL = ${SHELL} /luckcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /luckcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /luckcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /luckcoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = luckcoin-cli
BITCOIN_DAEMON_NAME = luckcoind
BITCOIN_GUI_NAME = luckcoin-qt
BITCOIN_TX_NAME = luckcoin-tx
BITCOIN_WALLET_TOOL_NAME = luckcoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The Luckcoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Luckcoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /luckcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = luckcoin
PACKAGE_BUGREPORT = https://github.com/luckcoin-project/luckcoin/issues
PACKAGE_NAME = Luckcoin Core
PACKAGE_STRING = Luckcoin Core 0.18.1
PACKAGE_TARNAME = luckcoin
PACKAGE_URL = https://luckcoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /luckcoin
abs_srcdir = /luckcoin
abs_top_builddir = /luckcoin
abs_top_srcdir = /luckcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /luckcoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Luckcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Luckcoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Luckcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Luckcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
