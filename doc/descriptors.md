# Support for Output Descriptors in Luckcoin Core

Since Luckcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Luckcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Luckcoin Core wallets, a convenience function `combo` is
