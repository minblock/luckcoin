...
{
    const char* pszTimestamp = "4/10/2020 Provigen Networks: Now accepting Onlyoutinthemiddleofnoshis!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586502583, 1786179, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5416e9d63f6f4b1aeb74dc0d68733f0684591059021cf7e4c53b4bf0b7b82b3c"));
        assert(genesis.hashMerkleRoot == uint256S("0xcbbcfeb7d2f330d89b62e9d9a6d8645638b456e7ba5300d78ed1bf138eef7c1c"));
        ...
        vSeeds.emplace_back("seed-a.luckcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.luckcointools.com");
        vSeeds.emplace_back("dnsseed.luckcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 822047, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x25e99bab430f4d179ba1f6e3cd87ca815d544e0f698e54ecd8b1f537e8a9aa2e"));
        assert(genesis.hashMerkleRoot == uint256S("0xcbbcfeb7d2f330d89b62e9d9a6d8645638b456e7ba5300d78ed1bf138eef7c1c"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.luckcointools.com");
        vSeeds.emplace_back("seed-b.luckcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1fdd55afbfdaef857537e2b2725f77ce3bb6c34ad250eb71273e3be41cb51238"));
        assert(genesis.hashMerkleRoot == uint256S("0xcbbcfeb7d2f330d89b62e9d9a6d8645638b456e7ba5300d78ed1bf138eef7c1c"));
