...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " luckcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  luckcoin-tx [options] <hex-tx> [commands]  Update hex-encoded luckcoin transaction\n" +
            "or:     luckcoin-tx [options] -create [commands]   Create hex-encoded luckcoin transaction\n" +
            "\n";
